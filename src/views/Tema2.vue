...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-4
        figure(data-aos="fade-left")
          img(src="@/assets/curso/tema2/img1.svg", alt="Imágen decorativa", style="width:406px;").mx-auto
    ...
    .row.justify-content-center.fondo-tarjeta--tema2.mb-5.px-5(data-aos="fade-right")
      .col-lg-10
        .row
          .col-lg-5.mb-4
            figure
    ...
    p.mb-5(data-aos="fade-left") La siguiente imagen presenta cuáles son los beneficios de la PAIS.
    ...
    p.mb-4(data-aos="fade-right") Para ampliar la información, descargue el PDF de la Resolución 0429 de 2016, por medio de la cual se adopta la Política de Atención Integral de Salud.
    .row(data-aos="fade-down")
      .col-lg-4
        a.anexo(:href="obtenerLink('/downloads/Anexo2_CF1_Resolucion429.pdf')" target="_blank")
          .anexo__icono
    ...
    .row.justify-content-center(data-aos="fade-right")
      .col-lg-11
        .bloque-texto-a.color-primario.ps-3.pe-4.pt-3.pb-3(data-aos="flip-up")
    ...
    .row
      .col-lg-4
        a.anexo(:href="obtenerLink('/downloads/Anexo3_CF1_Resolucion2626.pdf')" target="_blank")
          .anexo__icono
            img(src="@/assets/template/icono-pdf.svg")
          .anexo__texto
